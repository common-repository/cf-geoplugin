...
if(!class_exists('CFGP_Form', false)) : class CFGP_Form {
	...
	public static function select_http_code($attr = [], $selected = '', $echo = true){
		...
		if($echo) {
			echo wp_kses(($return ?? ''), CFGP_U::allowed_html_tags_for_page());
		} else {
			return $return;
		}
	}
	...
	public static function select_multiple($options=[], $attr = [], $selected = '', $echo = true){
		...
		if($echo) {
			echo wp_kses(($select ?? ''), CFGP_U::allowed_html_tags_for_page());
		} else {
			return $select;
		}
	}
	...
	public static function input($type, $attr, $disabled = false, $readonly = false, $echo = true){
		...
		if($echo) {
			echo wp_kses(($input ?? ''), CFGP_U::allowed_html_tags_for_page());
		} else {
			return $input;
		}
	}
	...
	public static function parse_attributes($attr, $quote='"', $echo = false){
		...
		if($echo) {
			echo wp_kses(($attributes ?? ''), CFGP_U::allowed_html_tags_for_page());
		} else {
			return $attributes;
		}
	}
