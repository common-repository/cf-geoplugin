...
<div class="wrap cfgp-wrap" id="<?php echo esc_attr(sanitize_text_field($_GET['page'] ?? NULL)); ?>">
	<h1 class="wp-heading-inline"><i class="cfa cfa-lock"></i> <?php esc_html_e('Anti Spam Protection & Site Restriction', 'cf-geoplugin'); ?></h1>
                    	...
                    	<div class="nav-tab-wrapper-chosen">
                            ...
                            <div class="cfgp-tab-panel cfgp-tab-panel-active" id="defender-settings">
                                ...
                                <div class="nav-tab-wrapper-chosen cfgp-country-region-city-multiple-form">
                                    <nav class="nav-tab-wrapper">
                                        <a href="javascript:void(0);" class="nav-tab nav-tab-active" data-id="#ip-restriction"><i class="cfa cfa-shield"></i><span class="label"> <?php esc_html_e('IP Restriction', 'cf-geoplugin'); ?></span></a>
                                        <a href="javascript:void(0);" class="nav-tab" data-id="#location-restriction"><i class="cfa cfa-globe"></i><span class="label"> <?php esc_html_e('Location Restriction', 'cf-geoplugin'); ?></span></a>
										<a href="javascript:void(0);" class="nav-tab" data-id="#proxy-restriction"><i class="cfa cfa-sitemap"></i><span class="label"> <?php esc_html_e('Proxy Restriction', 'cf-geoplugin'); ?></span></a>
										<a href="javascript:void(0);" class="nav-tab" data-id="#whitelist"><i class="cfa cfa-list"></i><span class="label"> <?php esc_html_e('Whitelist', 'cf-geoplugin'); ?></span></a>
                                    </nav>
                                    ...
                                    <div class="cfgp-tab-panel" id="location-restriction">
                                    	<div class="cfgp-form-group">
                                            <label for="block_country"><?php esc_html_e('Choose Countries', 'cf-geoplugin'); ?>:</label>
											<?php
									...
									<div class="cfgp-tab-panel" id="whitelist">
                                    	<div class="cfgp-form-group">
                                            <label for="ip_whitelist"><?php esc_html_e('Enter the IP addresses you want to whitelist and separate them with a comma or a new line', 'cf-geoplugin'); ?>:</label>
                            ...
                            <div class="cfgp-tab-panel" id="defender-settings-page">
                            	<p><?php esc_html_e('Message that is displayed to a blocked visitor (HTML allowed)', 'cf-geoplugin'); ?>:</p>
                                <div class="cfgp-form-group">
                                    <?php
